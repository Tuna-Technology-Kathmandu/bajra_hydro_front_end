...
const JobsList = ({ jobs }) => {
    return (
        <section className='w-full mt-14 px-3'>
            ...
            <div className='hidden md:grid w-full grid-cols-[1.5fr_1fr_2fr] gap-3 mb-3'>
            ...
            {jobs.map((job, index) => (
                <div
                    key={index}
                    className='grid md:grid-cols-[1.5fr_1fr_2fr] grid-cols-1 gap-2 md:gap-3 p-3 mb-4 rounded-md even:bg-[#48CAE41A] bg-white shadow-sm'
                >
                    <div>
